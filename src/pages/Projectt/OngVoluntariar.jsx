...
export default function Voluntariar() {
    return (
        <div>
            ...
            <footer style={{ position: "fixed", border:"2px solid", borderRadius:"5px", bottom: "0", left: "0", width: "100%", backgroundColor: "#4A806D", padding: "10px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
